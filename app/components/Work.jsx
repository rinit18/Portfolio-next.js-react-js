import { assets, workData } from '@/assets/assets'; // Import assets and project data
  ...
  return (
    ...
    id="work" className="w-full px-[12%] py-10 scroll-mt-20">
      ...
      className="text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo">
        Welcome to my web development portfolio. Here you can find some of my latest projects.
      </motion.p>
      ...
      className="grid grid-cols-auto my-10 gap-5">
        {/* Map through workData to display each project */}
        {workData.map((projects, index) => (
          ...
          transition={{ duration: 0.3 }}
            ...
            style={{ backgroundImage: `url(${projects.bgImage})` }} // Set background image dynamically
          >
            ...
            <div
              ...
              duration-500 group-hover:bottom-7 bg-lightHover group-hover:text-black"
            >
              ...
              {/* Icon for sending/viewing the project */}
              <div
                className="border rounded-full border-black
               w-9 aspect-square flex items-center justify-center shadow-[2px_2px_0_#000] 
...
export default Work; // Export the Work component
